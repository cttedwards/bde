...
model {
    ...
    for(i in 1:N_nz) {
    	...
    	mu_log[i] = beta0 + betaY[XY_sample_nz[i]] + betaA[XA_sample_nz[i]] + betaM[XM_sample_nz[i]] + betaC[XC_sample_nz[i]] + betaI[XY_sample_nz[i], XA_sample_nz[i]];
...
generated quantities {
	...
	for(i in 1:N[1]) {
		...
		mu_log      = beta0 + betaY[XY_sample[i]] + betaA[XA_sample[i]] + betaM[XM_sample[i]] + betaC[XC_sample[i]] + betaI[XY_sample[i], XA_sample[i]];
